...
public class InsertionSortAlgorithmTest {
    ...
    public void testShouldReturnUnsuccessfulOnEmptyArray() {
        assertArrayEquals(UNSUCCESSFUL, insertionSortAlgorithm.insertionSort(new int[0]));
    }

    @Test
    public void testShouldReturnAnArrayWithOneElement() {
        assertEquals(oneElementArray, insertionSortAlgorithm.insertionSort(oneElementArray));
    }

    @Test
    public void testShouldReturnSortedArrayWithEvenNumberOfElements() {
        assertArrayEquals(sortedInputArray, insertionSortAlgorithm.insertionSort(inputArray));
    }
